...
class TestView(object):
    ...
    # on_remove
    def test_view_on_remove(self, sentinel):
        s = sentinel(False)
    ...
    def test_view_on_remove_multiple_callback(self, sentinel):
        s = sentinel(0)
    ...
    # remove_remove
    def test_view_remove_remove(self, sentinel):
        s = sentinel(0)
        ...
        view.on_remove(cb1)
        view.on_remove(cb2)
        view.remove_remove(cb1)
        tbl.remove([data[0]["a"]])
        assert s.get() == 2

    def test_view_remove_multiple_remove(self, sentinel):
        s = sentinel(0)
        ...
        view.on_remove(cb1)
        view.remove_remove(cb1)
        assert len(view._remove_callbacks) == 1
        tbl.remove([data[0]["a"]])
        assert s.get() == 2
